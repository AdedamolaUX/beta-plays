      ...
      <div className="token-info">
        ...
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
            ...
            {isDirectDeriv  && <Tooltip text="Confirmed child — parent alpha detected when this token was scanned"><span className="badge badge-cabal" style={{ fontSize: 11, padding: '1px 3px', cursor: 'default' }}>🧬 CHILD</span></Tooltip>}
